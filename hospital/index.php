...
<head>
    ...
    <div
        style="max-width: 850px; margin: 10px auto 0 auto; padding: 20px; border-radius: 8px; border-left: 6px solid #007bff; font-size: 1rem; color: #333; line-height: 1.6; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); text-align: center;">
        <p style="margin: 0;">
            <strong style="color: #007bff;">For your security:</strong> Always use a secure connection when accessing
            sensitive information. Avoid sharing your login credentials and log out after your session, especially on
            shared or public devices. Regularly update passwords and stay cautious of suspicious links or messages
