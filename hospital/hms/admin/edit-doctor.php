...
if (strlen($_SESSION['id'] == 0)) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = mysqli_query($con, "Update doctors set specilization='$docspecialization',doctorName='$docname',address='$docaddress',docFees='$docfees',contactno='$doccontactno',docEmail='$docemail', accessLevel='$accessLevel' where id='$did'");
		if ($sql) {
