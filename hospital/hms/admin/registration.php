...
if(isset($_POST['submit'])) {
    // Sanitize inputs and ensure no special characters are injected
    $fname = filter_var(trim($_POST['full_name']), FILTER_SANITIZE_STRING);
    ...
    $stmt = $mysqli->prepare("INSERT INTO users (fullname, address, city, gender, email, password) VALUES (?, ?, ?, ?, ?, ?)");
